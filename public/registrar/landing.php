...
<?php
        $query2 = mysqli_query($con,"SELECT * from regis1 where id='".$_GET['id']."'");
...
$queryup0=mysqli_query($con,"UPDATE regis1 set name ='".$_POST['usname']."'WHERE id = '".$_GET['id']."'");
$queryup1=mysqli_query($con,"UPDATE regis1 set address ='".$_POST['usadd']."'WHERE id = '".$_GET['id']."'");
$queryup2=mysqli_query($con,"UPDATE regis1 set contact_no ='".$_POST['uscont']."'WHERE id = '".$_GET['id']."'");
$queryup2=mysqli_query($con,"UPDATE regis1 set transac_desc ='".$_POST['ustrandes']."'WHERE id = '".$_GET['id']."'");
$queryup3=mysqli_query($con,"UPDATE regis1 set price ='".$_POST['usprice']."'WHERE id = '".$_GET['id']."'");
...
if (isset($_POST['remove'])){
    ...
    $querydel=mysqli_query($con,"DELETE FROM regis1 WHERE id='".$_GET['id']."'");
