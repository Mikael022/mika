...
<?php
        $query2 = mysqli_query($con,"SELECT * from regis2 where id='".$_GET['id']."'");
...
$queryup0=mysqli_query($con,"UPDATE regis2 set name ='".$_POST['usname']."'WHERE id = '".$_GET['id']."'");
$queryup1=mysqli_query($con,"UPDATE regis2 set address ='".$_POST['usadd']."'WHERE id = '".$_GET['id']."'");
$queryup2=mysqli_query($con,"UPDATE regis2 set contact_no ='".$_POST['uscont']."'WHERE id = '".$_GET['id']."'");
$queryup2=mysqli_query($con,"UPDATE regis2 set transac_desc ='".$_POST['ustrandes']."'WHERE id = '".$_GET['id']."'");
$queryup3=mysqli_query($con,"UPDATE regis2 set price ='".$_POST['usprice']."'WHERE id = '".$_GET['id']."'");
...
if (isset($_POST['remove'])){
    ...
    $querydel=mysqli_query($con,"DELETE FROM regis2 WHERE id='".$_GET['id']."'");
